...
class SubscriberNode : public rclcpp::Node {
  public:
    SubscriberNode() : Node("imu_lidar_subscriber") {
        ...
        lidar_subscriber_ = create_subscription<sensor_msgs::msg::PointCloud2>(
            ...
            std::bind(&SubscriberNode::lidar_callback, this, std::placeholders::_1));
  ...
  private:
    void imu_callback(const sensor_msgs::msg::Imu::SharedPtr msg) {
        ...
        imu_shift[imu_queue_cursor_] = imu_shift[imu_ptr_back] +
                                       imu_velocity[imu_ptr_back] * time_diff +
                                       acceleration * time_diff * time_diff * 0.5;
        ...
        transform_msg.child_frame_id = imu_frame;
    ...
    void lidar_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
        ...
        auto [cloud_map, cloud_keypoints, new_pose] =
            kiss_icp::register_frame(points, imu_deskew, imu_motion, imu_deskew_timestamp);
        ...
        map_publisher_->publish(
            std::move(EigenToPointCloud2(kiss_icp::slam_ctx.get_registered_map(), map_msg.header)));
    }
